...
class _ScanCameraScreenState extends State<ScanCameraScreen> with WidgetsBindingObserver {
  ...
  Future<void> _processImage(File imageFile) async {
    ...
    ScanProgressDialog.show(context, initialMessage: 'Analyzing with AI...');

    try {
      ScanProgressDialog.updateMessage(context, 'Saving image...');
      final localPath = await _service.saveImageLocally(imageFile);
  ...
  Widget _buildCameraView() {
    ...
    final cameraAspectRatio = previewSize != null ? previewSize.height / previewSize.width : 1.0;
